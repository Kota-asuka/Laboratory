    ...
    protected void think() {
        ...
        switch (season) {
            ...
            case "05":
                // 前半戦
                if (this.handNum == 0) {
                    this.putWorker(C1, "1-1", "G");
                } else if (this.handNum == 1) {
                    this.putWorker(C2, "1-1", "F");
                }
                if ((C1.equals("L") || C2.equals("L")) && this.handNum == 2) {
                    this.putWorker("A", "1-1", "F");
                }
                break;
            case "06":
            case "07":
            ...
            case "10":
                ...
                if ((C1.equals("L") || C2.equals("L")) && this.handNum == 3) {
                    this.putWorker("A", "1-1", "F");
                }
                break;
        }
