...
public class ClientGUI extends javax.swing.JFrame implements MessageRecevable {
    ...
    //ウィンドウタイトル
    private static final String WINDOW_TITLE = "SampleClient 2020 ver 1.21";
    ...
    private void initComponents() {
        ...
        Chara1Box = new javax.swing.JComboBox<>();
        Chara2Box = new javax.swing.JComboBox<>();
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "1-1(ゼミ)", "2-1(図書館)", "2-2(図書館)", "3-1(実験)", "3-2(実験)", "3-3(実験)", "3-4(実験)", "4-1(発表)", "4-2(発表)", "4-3(発表)", "4-4(発表)", "4-5(発表)", "5-1(論文)", "5-2(論文)", "5-3(論文)", "5-4(論文)", "5-5(論文)", "6-1(研究報告)", "6-2(研究報告)", "6-3(研究報告)" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "F", "G", "M", "FF", "FG", "GG" }));
        ...
        Chara1Box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "G (天才科学者)", "H (努力家)", "E (エンジニア)", "R (リサーチャー)", "L (リーダー)", "M (マネージャー)" }));

        Chara2Box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "G (天才科学者)", "H (努力家)", "E (エンジニア)", "R (リサーチャー)", "L (リーダー)", "M (マネージャー)" }));
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(Chara1Box, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(Chara2Box, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (this.jCheckBox2.isSelected()) {
            ...
            this.Chara1Box.setEnabled(false);
            this.Chara2Box.setEnabled(false);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        // プレイメッセージをセット
        String line = "104 CHARACTER ";
        // 選択したものを取得
        String select1 = ((String) this.Chara1Box.getSelectedItem());
        String select2 = ((String) this.Chara2Box.getSelectedItem());
        // 切り出し
        String chara1 = select1.substring(0, 1);
        String chara2 = select2.substring(0, 1);
        if (chara1.equals("-") || chara2.equals("-")) {
            JOptionPane.showMessageDialog(this, "キャラクターが選択されていません", "error!", JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (chara1.equals(chara2)) {
            JOptionPane.showMessageDialog(this, "同じキャラクターが選択されています！", "error!", JOptionPane.ERROR_MESSAGE);
            return;
        }
        // 送信
        line += chara1 + " " + chara2;
        ...
        this.jComboBox1.addItem(select1);
        this.jComboBox1.addItem(select2);
        this.jComboBox1.addItem("S (学生)");
        if (chara1.equals("L") || chara2.equals("L")) {
            this.jComboBox1.addItem("A (リーダー補助コマ)");
        }
    ...
    private javax.swing.JComboBox<String> Chara1Box;
    private javax.swing.JComboBox<String> Chara2Box;
